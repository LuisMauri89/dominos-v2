...
import (
	...
	"api-rest-con-master-mold/cmd/config"
	"api-rest-con-master-mold/internal/client"
	"api-rest-con-master-mold/internal/endpoint"
	"api-rest-con-master-mold/internal/handler"
...
func main() {
	...
	endpoint_api = commons.EndpointLogMiddleware("endpoint_client", logger)(endpoint_api)

	//Implementación de un GET dinámico
	endpoint_character := client.MakeHTTPClientCharacterEndpoint(url, timeout, logger)
	endpoint_character = commons.EndpointLogMiddleware("api_characters", logger)(endpoint_character)
